...
class freeradius::v3::modules::ldap (
  ...
  Array[Simplib::Uri]      $server                                         = simplib::lookup('simp_options::ldap::uri', { 'default_value'     => ["ldap://%{hiera('simp_options::puppet::server')}"]})
  ...
  Freeradius::Scope        $client_scope                                   = undef,
  ...
  Freeradius::Scope        $group_scope                                    = undef,
  ...
  String                   $group_cacheable_name                           = false,
  String                   $group_cacheable_dn                             = false,
  ...
  Freeradius::Scope        $user_scope            = 'nil',
) {
